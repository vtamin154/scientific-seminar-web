        ...
        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
            ...
            <li>
                ...
                <ul class="collapse nav flex-column ms-1" id="submenu3" data-bs-parent="#menu">
                    <li class="w-100">
                        <a href="speaker.php" class="nav-link px-0 text-white">1. <span class="d-none d-sm-inline">Diễn giả</span></a>
                    </li>
                    <li>
                        <a href="event.php" class="nav-link px-0 text-white">2. <span class="d-none d-sm-inline">Sự kiện</span></a>
                    </li>
                    <li>
                        <a href="regiseventdb.php" class="nav-link px-0 text-white">3. <span class="d-none d-sm-inline">Danh sách tham dự</span></a>
                    </li>
                </ul>
            </li>
